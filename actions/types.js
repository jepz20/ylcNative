...
export const SCOOP_MATCH = '@match/scoop_match'
export const HALF_POINTS = '@match/half_points'
export const ADD_POINTS = '@match/add_points'
...
export type ERASE_STR = '@erase'
export type SCOOP_MATCH_STR = '@match/scoop_match'
export type HALF_POINTS_STR = '@match/half_points'
export type ADD_POINTS_STR = '@match/add_points'
export type DRAW_STR = '@draw'
